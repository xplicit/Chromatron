...
/// <summary> 
/// Represents a drag zone on the main window. 
/// </summary>
public class DragZoneConfiguration
{
    /// <summary> 
    /// The height of the drag zone, typically at the top of the window. 
    /// </summary>
    /// <value> 
    /// The height of the drag zone. 
    /// </value>
    public int Height { get; set; }

    /// <summary> 
    /// The offset from the top of the frame to start the drag area. 
    /// </summary>
    /// <value> 
    ...
    /// <summary> 
    /// The offset from the left of the frame to start the drag area. 
    /// </summary>
    /// <value> 
    /// The offset from the left of the frame. 
    /// </value>
    public int LeftOffset { get; set; }

    /// <summary> 
    /// The offset from the right of the frame to start the drag area. 
    /// </summary>
    /// <value> 
    /// The offset from the right of the frame. 
    /// </value>
