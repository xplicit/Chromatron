...
public class FramelessOption
{
    ...
    /// </value>
    public Func<IChromatronNativeHost, Point, bool> IsDraggable { get; set; }
    ...
    /// </value>
    public Action<IChromatronNativeHost> DblClick { get; set; }
    ...
    /// </summary>
    /// <param name="nativeHost"> The Chromatron native host interface. </param>
    /// <param name="point">      The click point. </param>
    /// <returns> True if in the drag region, false if not. </returns>
    public bool IsDraggableCallbackFunc(IChromatronNativeHost nativeHost, Point point)
    {
    ...
    /// </summary>
    /// <param name="nativeHost"> The Chromatron native host interface. </param>
    public static void DblClickCallbackFunc(IChromatronNativeHost nativeHost)
    {
