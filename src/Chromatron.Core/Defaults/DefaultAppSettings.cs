...
/// <summary>
/// The default implementation of <see cref="IChromatronAppSettings"/>.
/// </summary>
public class DefaultAppSettings : IChromatronAppSettings
{
    private ChromatronDynamic? _chromatronDynamic;
    ...
    public DefaultAppSettings(string appName = "chromatron")
    {
        AppName = appName;
    }
    ...
    public dynamic Settings
    {
        get
        {
            if (_chromatronDynamic is null)
            {
                _chromatronDynamic = new ChromatronDynamic();
            }

            return _chromatronDynamic;
        }
    }

    /// <inheritdoc/>
    public virtual void Read(IChromatronConfiguration config)
    {
        try
        {
            ...
            if ((info.Exists) && info.Length > 0)
            {
                ...
                _chromatronDynamic = new ChromatronDynamic(settingsDic);
            }
    ...
    /// <inheritdoc/>
    public virtual void Save(IChromatronConfiguration config)
    {
        try
        {
            if (_chromatronDynamic is null ||
                _chromatronDynamic.Empty ||
                _chromatronDynamic.Dictionary is null ||
                _chromatronDynamic.Dictionary.Count == 0)
            {
                return;
            }
            ...
            try
            {
                ...
                var jsonDic = JsonSerializer.Serialize(_chromatronDynamic.Dictionary, options);
