...
public abstract partial class ChromiumBrowser
{
    ...
    protected readonly ChromatronHandlersResolver _handlersResolver;
    ...
    public ChromiumBrowser(IChromatronNativeHost nativeHost, IChromatronConfiguration config, ChromatronHandlersResolver handlersResolver)
    {
        Browser = null;
    ...
    /// </summary>
    public IChromatronNativeHost NativeHost { get; private set; }
