...
public static class HandlerResolverHelper
{
    ...
    /// </remarks>
    /// <param name="resolver">Instance of <see cref="ChromatronHandlersResolver"/>.</param>
    /// <param name="type">The handler type.</param>
    /// <returns>instance of handler object.</returns>
    public static object? GetCustomOrDefaultHandler(this ChromatronHandlersResolver resolver, Type type)
    {
    ...
    /// <returns>instance of handler object.</returns>
    public static object? GetFirstCustomOrDefaultHandler(this ChromatronHandlersResolver resolver, Type type, Type defaultType)
    {
    ...
    /// <param name="defaultType">The default handler type.</param>
    /// <returns>instance of handler object.</returns>
    public static object? GetDefaultHandler(this ChromatronHandlersResolver resolver, Type type, Type defaultType)
    {
        var handlers = resolver?.Invoke(type)?.ToList();
        if (handlers is not null && handlers.Any())
        {
