...
public static class CefBinariesLoader
{
    ...
    public static void Load(ICefDownloader cefBinariesDownloader, IChromatronConfiguration config)
    {
        try
        {
    ...
    /// </summary>
    private static void DownloadAndNotifyUser(ICefDownloader cefBinariesDownloader, IChromatronConfiguration config)
    {
        var downloadNotification = cefBinariesDownloader.Notification;
