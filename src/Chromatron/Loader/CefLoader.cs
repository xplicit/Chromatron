...
public class CefLoader
{
    ...
    public static void Download(ChromatronPlatform platform)
    {
    ...
    private readonly ChromatronPlatform _platform;
    ...
    private CefLoader(ChromatronPlatform platform)
    {
        _platform = platform;
    ...
    {
        if (config.Platform == ChromatronPlatform.MacOSX)
        {
            Task.Run(() =>
            {
                try
    ...
    private void CopyFilesToAppDirectory()
    {
        ...
        var appDirectory = AppDomain.CurrentDomain.BaseDirectory;
        if (_platform != ChromatronPlatform.MacOSX)
        {
        ...
        if (_platform != ChromatronPlatform.MacOSX) return;
