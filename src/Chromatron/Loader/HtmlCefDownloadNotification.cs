                ...
                new XElement(
                    "html",
                                ...
                                new XElement(
                                    ...
                                    new XElement("title", "Chromatron CEF Binaries Download"),
                                    new XElement(
                                        "style",
                                ...
                                new XElement(
                                    ...
                                    new XElement(
                                        "img",
                                        new XAttribute("src", ChromatronImgBase6Encoded)),
                                    new XElement("h1", "chromatron"),
                                    new XElement("div", message.Item1),
                                    new XElement("div", message.Item2),
                                    new XElement("div", message.Item3),
                                    new XElement("p", string.Empty),
                                    new XElement("div", "For more info - ", new XElement("a", "Chromatron Apps", new XAttribute("href", "https://github.com/xplicit/Chromatron"))),
                                    new XElement("p", string.Empty),
                                    new XElement(
                                        "input",
