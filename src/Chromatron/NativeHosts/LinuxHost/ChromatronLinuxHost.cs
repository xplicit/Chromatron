...
/// </summary>
public partial class ChromatronLinuxHost : IChromatronNativeHost
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ChromatronLinuxHost"/>.
    /// </summary>
    /// <param name="config">Instance of <see cref="IChromatronConfiguration"/>.</param>
    public ChromatronLinuxHost(IChromatronConfiguration config)
    {
        _config = config;
