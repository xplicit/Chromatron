...
/// </summary>
public partial class ChromatronMacHost : IChromatronNativeHost
{
    ...
    private ChromatronParam _configParam;
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ChromatronMacHost"/>.
    /// </summary>
    /// <param name="config">Instance of <see cref="IChromatronConfiguration"/>.</param>
    public ChromatronMacHost(IChromatronConfiguration config)
    {
        _config = config;
    ...
    {
        Logger.Instance.Log.LogInformation("ChromatronMacHost::SetWindowTitle is not implemented yet!");
    }
    ...
    /// <summary>
    /// Interop - run callback (required by libchromatron.dylib).
    /// </summary>
    protected virtual void RunCallback()
    {
        ...
        {
            Logger.Instance.Log.LogError("Error in ChromatronMacHost::RunCallback");
            Logger.Instance.Log.LogError(exception, exception.Message);
        }
    }

    /// <summary>
    /// Interop - shut down callback (required by libchromatron.dylib).
    /// </summary>
    ...
    /// <summary>
    /// Interop - init callback (required by libchromatron.dylib).
    /// </summary>
    ...
    /// <summary>
    ///  Interop - create callback (required by libchromatron.dylib).
    /// </summary>
    ...
    /// <summary>
    /// Interop - moving callback (required by libchromatron.dylib).
    /// </summary>
    ...
    /// <summary>
    /// Interop - resize callback (required by libchromatron.dylib).
    /// </summary>
    ...
    /// <summary>
    /// Interop - close browser (required by libchromatron.dylib).
    /// </summary>
    ...
    protected virtual int CloseBrowser()
    {
        ...
        {
            Logger.Instance.Log.LogError("Error in ChromatronMacHost::CloseBrowser");
            Logger.Instance.Log.LogError(exception, exception.Message);
        }
    ...
    /// <summary>
    /// Interop - quit Cocoa app callback (required by libchromatron.dylib).
    /// </summary>
    protected virtual void QuitCallback()
    {
        ...
        {
            Logger.Instance.Log.LogError("Error in ChromatronMacHost::QuitCallback");
            Logger.Instance.Log.LogError(exception);
        }
    }

    private static ChromatronParam InitParam(RunMessageLoopCallback runCallback,
                                                ...
                                                QuitCallbackEvent quitCallback)
    {
        ...
        ChromatronParam configParam = new();
