...
public class DefaultWindowMessageInterceptor : IWindowMessageInterceptor
{
    ...
    public DefaultWindowMessageInterceptor(IChromatronConfiguration config)
    {
        _config = config;
    }
    ...
    public virtual void Setup(IChromatronNativeHost nativeHost, IntPtr browserHandle)
    {
    ...
    protected class DragWindowHandler
    {
        ...
        private readonly IChromatronNativeHost _nativeHost;
        ...
        public DragWindowHandler(IntPtr handle, IChromatronNativeHost nativeHost, FramelessOption framelessOption)
        {
            _handle = handle;
            _nativeHost = nativeHost;
