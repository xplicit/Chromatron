...
using Chromatron.NativeHosts.Helpers;
...
/// </summary>
public abstract partial class WinHostBase : IChromatronNativeHost
{
    ...
    protected const string Chromatron_WINDOW_CLASS = "ChromatronWindowClass";
    ...
    public WinHostBase(IChromatronConfiguration config, IWindowMessageInterceptor messageInterceptor, IKeyboardHookHandler keyboardHandler)
    {
        _config = config;
    ...
    public virtual unsafe void CreateWindow()
    {
        ...
        fixed (char* c = Chromatron_WINDOW_CLASS)
        {
        ...
        {
            Logger.Instance.Log.LogError("Chromatronwindow registration failed");
            return;
        }
        ...
        if (hWnd == IntPtr.Zero)
        {
            Logger.Instance.Log.LogError("Chromatronwindow creation failed");
            return;
        }
