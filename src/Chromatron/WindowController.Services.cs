...
public partial class WindowController
{
    ...
    /// <summary>
    /// This is used to register custom scheme handlers. Handlers must implement <see cref="IChromatronSchemeHandler"/>.
    /// </summary>
    protected virtual void RegisterCustomSchemeHandlers()
    {
        ...
        if (schemeHandlerList is not null && schemeHandlerList.Any())
        {
            ...
            {
                if (schemeHandlerObj is not IChromatronSchemeHandler schemehandler ||
